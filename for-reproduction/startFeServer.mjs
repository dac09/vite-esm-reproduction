...
// For ESM.
const { getPaths, getConfig } = projectConfig

// For ESM again.
import rwRouter from '@redwoodjs/router'
const {matchPath} = rwRouter

import { triggerRouteHooks } from '@redwoodjs/vite/dist/triggerRouteHooks.js'
import { stripQueryStringAndHashFromPath } from '@redwoodjs/vite/dist/utils.js'
